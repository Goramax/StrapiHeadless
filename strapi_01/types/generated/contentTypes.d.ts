...
export interface ApiCreateBurgerCreateBurger extends Schema.SingleType {
  collectionName: 'create_burgers';
  info: {
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<
      'api::create-burger.create-burger',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiIngredientIngredient extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ingredient_type: Attribute.Relation<
...
export interface ApiIngredientTypeIngredientType extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::create-burger.create-burger': ApiCreateBurgerCreateBurger;
